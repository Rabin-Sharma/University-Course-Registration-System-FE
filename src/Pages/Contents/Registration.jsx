...
import ContentLabel from '../Components/Registration/ContentLabel';
import ProgressSteps from '../Components/Registration/ProgressSteps';
import CreditLimit from '../Components/Registration/CreditLimit';
import CourseSelection from '../Components/Registration/CourseSelection';
import ReviewAndConflicts from '../Components/Registration/ReviewAndConflicts';
...
const Registration = () => {
  ...
  const confirmRegistration = () => {
    ...
    toast.success('Registration confirmed successfully! You will receive a confirmation email shortly.');
